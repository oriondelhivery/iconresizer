<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="app-icon-resizer-logo-v3.png">
    <source media="(prefers-color-scheme: light)" srcset="resizer-logo-black-v3.png">
    <img alt="Delhivery Icon Resizer" src="app-icon-resizer-logo-v3.png" width="320">
  </picture>
</p>
...
- 🖼️ **Automatic Logo Switching**  
  - Dark mode → `app-icon-resizer-logo-v3.png`  
  - Light mode → `resizer-logo-black-v3.png`  
- 💾 **Smart ZIP Naming**  
...
- 💠 **Includes Favicon**  
  - Custom `favicon-v2.png` included for easy branding
...
1. Upload the following files to your repository:
   ...
   style.css
   script.js
   app-icon-resizer-logo-v3.png
   resizer-logo-black-v3.png
   favicon-v2.png
   ```
